export function Alert() {
  return (
    <div className="border-2 border-[#FBC02D] bg-[#111111] px-5 py-3 gap-[10px] rounded-[10px] flex items-center justify-start min-w-max">
      <svg
        width="22"
        height="22"
        viewBox="0 0 20 20"
      ...
      <p className="text-[#FBC02D] text-[16px]">
