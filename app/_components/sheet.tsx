    ...
    <AnimatePresence initial={false}>
      {open && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className='fixed w-screen h-screen inset-0 z-[100] sheet overscroll-none'
      ...
      {open && (
        <motion.div
          className={cn(
            ...
            'fixed h-screen inset-0 z-[100] sheet-content overscroll-none overflow-y-scroll overflow-x-hidden'
          )}
          key={2}
          initial={{ x: -350 }}
          animate={{ x: 0 }}
