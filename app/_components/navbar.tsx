...
function Navbar({transparent = false} : {transparent? : boolean}) {
  return (
    <div className={`w-full flex items-center justify-between px-5 py-5 ${!transparent ? "border-b border-b-[#27272A]" : "bg-transparent"}`}>
      ...
      <div className="flex items-center justify-center gap-8">
        <Link href="/docs" className="text-[16px] font-medium">
          Docs
        </Link>
        <Link href="/contributors" className="text-[16px] font-medium">
          Sponsor
        </Link>
